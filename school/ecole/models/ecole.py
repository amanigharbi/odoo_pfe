...
class EcoleStandard(models.Model):
    ...
    user_id = fields.Many2one('ecole.teacher', 'Class Teacher')
...
class SubjectSubject(models.Model):
    ...
    teacher_ids = fields.Many2many('ecole.teacher', 'subject_teacher_rel',
...
class StudentPreviousEcole(models.Model):
    ''' Defining a student previous ecole information '''
    _name = "student.previous.ecole"
    _description = "Student Previous Ecole"

    previous_ecole_id = fields.Many2one('student.student', 'Student')
    name = fields.Char('Name', required=True)
...
class AcademicSubject(models.Model):
    ...
    add_sub_id = fields.Many2one('student.previous.ecole', 'Add Subjects',
                                 invisible=True)
    name = fields.Char('Name', required=True)
    maximum_marks = fields.Integer("Maximum marks")
    minimum_marks = fields.Integer("Minimum marks")
