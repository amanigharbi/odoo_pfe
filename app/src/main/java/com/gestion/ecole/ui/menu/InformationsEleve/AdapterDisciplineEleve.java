...
public class AdapterDisciplineEleve extends RecyclerView.Adapter<AdapterDisciplineEleve.ViewHolder> {
    ArrayList<ItemDesciplineEleve> list;
    Context context;

    public AdapterDisciplineEleve(ArrayList<ItemDesciplineEleve> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AdapterDisciplineEleve.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(context).inflate(R.layout.view_descipline_eleve, parent, false);
        return new AdapterDisciplineEleve.ViewHolder(v);
    }
